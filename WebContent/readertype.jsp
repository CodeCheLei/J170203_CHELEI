    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 id="title" class="modal-title"\>添加读者类型信息</h4>
            </div>
            <div class="modal-body">  	
            	<div id="content" style="font-size:20px;border:1px solid #ccc;height:100px">读者类型名称:<input id="newredertype" type="text"></input><br/>
            									可借数量&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:<input id="newredertypenum" type="text"></input>				
            	</div>
            </div>
		...
		<table width="99%" height="117"  align="center"
			...
			<tr align="right">
				...
				<td width="20%" height="10" align="center">
					<a id="add" href="#" class="detail" data-toggle="modal" data-target="#myModal"><font size="2" color="blue">添加读者类型信息</font></a>
				</td>
			</tr>
			<tr class="tr1">
				<td width="40%" height="29" align="center">
					<font size="2">读者类型名称</font>
				</td>
				<td width="40%" height="29" align="center">
					<font size="2">可借数量</font>
				</td>
			...
			<c:forEach items="${sessionScope.list }" var="li">
				<tr class="tr1" align="center">
					<td width="40%" height="29" align="left">
						<font size="2">${li.names }</font>
					</td>
					<td width="40%" height="29" align="left">
						<font size="2">${li.number }</font>
					</td>
					<td width="20%" height="29" align="center">
...
<script type="text/javascript">
	$("#save").click(function(){
		var names=$("#newredertype").val();
		var number=$("#newredertypenum").val();
		$.ajax(
				{
					"type":"post", 
					"url":"/library2/act10",  
					"data":{"names":names,"number":number},
